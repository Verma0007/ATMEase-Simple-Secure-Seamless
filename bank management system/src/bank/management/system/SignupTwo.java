...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno) {
        ...
        additonalDetails.setFont(new Font("Raleway", Font.BOLD, 38));
        additonalDetails.setBounds(140, 20, 600, 40);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            Matcher panMatcher = panPattern.matcher(span);
            ...
            Matcher aadharMatcher = aadharPattern.matcher(saadhar);
            ...
            // Hide current window and show next window
            setVisible(false);
